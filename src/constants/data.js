...
export const questionsForWomans = [
  ...
  },
  {
    id: 6,
    questionText:
      "Присутствует резкая боль в движении и покое после прогулки ?",
    options: ["Почти не бывает", "Да", "Иногда", "Нет"],
  },
  {
    id: 7,
...
export const reviews = [
  {
    ...
    job: "Бухгалтер",
    image: reviewOne,
    text: 'Мне 50 лет, и я тоже еле ходила. Когда я был молода, я не думала, что такое может со мной пройзойти. Косточка в суставе выросла большой, и мои ноги не могли поместиться ни в одну обувь. Было так больно, что я не носила тапочки дома. Однажды я зашла в магазин за обувью и примерила туфли, они не поместились. Я заплакала от боли, подошел продавец и спросил, Что случилось. Я сказала, что у меня болит нога, я не знаю, что делать. Он предложил мне "Flex-balance". Он сказал, что такая же история произошла и с ним, а теперь он носит туфли с тонким клювом. Поверив ему, я пришла домой и заказала. Помог! Я вам тоже советую. ',
  },
  {
    id: 2,
    ...
    job: "Менеджер",
    image: reviewTwo,
    text: "Я, как человек, предпочитающий естественные методы, был впечатлен составом препарата. После использования заметил значительное улучшение потенции без каких-либо побочных эффектов. LibidoFortis  отличный выбор для тех, кто ценит свое здоровье.      ",
  },
  {
    id: 3,
    ...
    job: "Домохозяйка",
    image: reviewThree,
    text: "Мы вместе с моим мужем решили попробовать препарат ManBalance. Результаты просто поразительны! Новые ощущения, большая близость. Это как возвращение к началу отношений. Спасибо, что вернули нам страсть!",
  },
  {
    id: 4,
    name: "Виктория Ли",
    ...
    customerReviews: [
      {
        ...
        date: "22 июня 2023",
        content:
          "Препарат ManBalance реально помог. Улучшилось общее самочувствие и добавилось сил! ",
        helpfulCount: 12,
        image: manbalanceImg,
      },
      {
        ...
        date: "12 июля 2023",
        content:
          "Мой муж стал использовать ManBalance и результаты нас обоих устроили. Спасибо!",
        helpfulCount: 19,
      },
      {
        id: 3,
        ...
        date: "5 августа 2023",
        content:
          "Начал принимать ManBalance по совету друга. Заметил положительные изменения уже через неделю.",
        helpfulCount: 7,
      },
    ...
    customerReviews: [
      {
        ...
        date: "12 января 2024",
        content:
          "С началом приёма BodyBalance я почувствовал новый прилив сил. Вес начал уходить, а жизненный тонус заметно повысился.",
        helpfulCount: 12,
      },
      {
        id: 2,
        ...
        content:
          "BodyBalance помог мне восстановить контроль над своим весом после новогодних праздников. Это был настоящий прорыв для меня!",
        helpfulCount: 9,
      },
      {
        id: 3,
        ...
        date: "6 марта 2024",
        content:
          "Этот препарат стал моим верным помощником на пути к здоровому телу. Рекомендую BodyBalance всем, кто сталкивается с затруднениями в похудении.",
        helpfulCount: 5,
      },
      {
        id: 4,
        ...
        content:
          "С BodyBalance я забыла о диетах. Теперь я могу есть все, что люблю, и при этом худею. Это чудо!",
        helpfulCount: 18,
      },
      {
        id: 5,
        ...
        date: "15 ноября 2023",
        content:
          "За короткий срок BodyBalance помог мне избавиться от лишних килограммов, которые мешали мне наслаждаться жизнью.",
        helpfulCount: 26,
      },
      // Add more review objects as needed
    ],
    ...
    customerReviews: [
      {
        ...
        date: "5 февраля 2024",
        content:
          "AlcoBalance помог мне справиться с тягой к алкоголю. Чувствую себя намного лучше и полон сил.",
        helpfulCount: 8,
      },
      {
        id: 2,
        ...
        date: "12 марта 2024",
        content:
          "Препарат действительно работает. Мой муж перестал пить, и наша семья снова счастлива.",
        helpfulCount: 14,
      },
      {
        id: 3,
        ...
        date: "25 января 2024",
        content:
          "С AlcoBalance моя жизнь изменилась. Я больше не зависим от алкоголя и начал новую жизнь.",
        helpfulCount: 5,
      },
      {
        id: 4,
        ...
        date: "9 марта 2024",
        content:
          "Замечательное средство для борьбы с алкоголизмом. Я смогла оставить пить благодаря AlcoBalance.",
        helpfulCount: 11,
      },
      {
        id: 5,
        ...
        content:
          "Это средство помогло мне в трудные времена. Благодарю разработчиков за AlcoBalance!",
        helpfulCount: 7,
      },
      // Add more review objects as needed
    ],
    ...
    customerReviews: [
      {
        ...
        date: "15 февраля 2024",
        content:
          "FlexBalance помог мне избавиться от болей в коленях, которые мешали мне заниматься спортом. Очень благодарна!",
        helpfulCount: 26,
      },
      {
        id: 2,
        ...
        date: "3 марта 2024",
        content:
          "После двух недель использования FlexBalance мои суставы стали значительно лучше. Рекомендую данный продукт!",
        helpfulCount: 14,
      },
      {
        id: 3,
        ...
        date: "21 января 2024",
        content:
          "FlexBalance стал настоящим спасением для моих суставов. Теперь могу заниматься садоводством без дискомфорта.",
        helpfulCount: 19,
      },
      {
        id: 4,
        ...
        content:
          "Благодарю за FlexBalance! Чувствую облегчение и подвижность в суставах, которых не было уже долгое время.",
        helpfulCount: 22,
      },
      // Add more review objects as needed
    ],
    ...
    customerReviews: [
      {
        ...
        date: "15 февраля 2024",
        content:
          "После двух недель применения EroKing я заметил значительные улучшения. Очень доволен результатом!",
        helpfulCount: 22,
      },
      {
        id: 2,
        ...
        date: "3 марта 2024",
        content:
          "EroKing помог мне вернуть уверенность в себе. Рекомендую всем, кто столкнулся с подобными проблемами!",
        helpfulCount: 17,
      },
      {
        id: 3,
        ...
        date: "21 января 2024",
        content:
          "Мой муж стал использовать EroKing, и мы оба заметили изменения к лучшему. Спасибо за такой продукт!",
        helpfulCount: 35,
      },
      {
        id: 4,
        ...
        date: "28 января 2024",
        content:
          "Препарат EroKing реально работает. Улучшилась не только потенция, но и общее состояние.",
        helpfulCount: 29,
      },
      // Add more review objects as needed
    ],
    ...
    customerReviews: [
      {
        ...
        date: "5 ноября 2023",
        content:
          "LibidoFortis действительно помогает. Чувствую себя гораздо лучше и увереннее.",
        helpfulCount: 12,
      },
      {
        id: 2,
        ...
        date: "22 января 2024",
        content:
          "Мой муж начал принимать LibidoFortis, и наши отношения значительно улучшились. Спасибо за ваш продукт!",
        helpfulCount: 27,
      },
      {
        id: 3,
    ...
    customerReviews: [
      {
        ...
        date: "8 марта 2024",
        content:
          "FemBalance стал настоящим спасением для меня. Улучшилось общее самочувствие, и я чувствую себя полной энергии. Кожа и волосы также выглядят лучше!",
        helpfulCount: 26,
      },
      {
        id: 2,
        ...
        content:
          "После начала приема FemBalance, я заметила, как мое состояние заметно улучшилось. Гормональный фон стабилизировался, и я почувствовала прилив сил.",
        helpfulCount: 34,
      },
      {
        id: 3,
        ...
        date: "15 января 2024",
        content:
          "Использую FemBalance уже два месяца и не могу нарадоваться на результаты. Это действительно работает, и я рекомендую его всем своим подругам.",
        helpfulCount: 19,
      },
      {
        id: 4,
        ...
        date: "2 декабря 2023",
        content:
          "Удивительно, но FemBalance помог мне восстановить баланс и энергию. Теперь я чувствую себя намного лучше, и мои дни стали ярче и продуктивнее.",
        helpfulCount: 22,
      },
      // Add more review objects as needed
    ],
